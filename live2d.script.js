!function(t) {
    ...
    s.prototype.updateParam = function(t) {
        ...
        case d.STATE_CLOSED:
            ...
            r >= 1 && (this.eyeState = d.STATE_OPENING,
            this.stateStartTime = e),
            i = 0;
            break;
        ...
        case d.STATE_INTERVAL:
            this.nextBlinkTime < e && (this.eyeState = d.STATE_CLOSING,
            this.stateStartTime = e),
            i = 1;
            break;
        case d.STATE_FIRST:
...
, function(t, i, e) {
    ...
    function o(t) {
        ...
        F.addEventListener && (window.addEventListener("click", g),
    ...
    function n(t) {
        ...
        var r = e / i
          ...
          , _ = -r
          , h = r;
        if (N = new L.L2DViewMatrix,
        N.setScreenRect(o, n, _, h),
        N.setMaxScreenRect(I.default.VIEW_LOGICAL_MAX_LEFT, I.default.VIEW_LOGICAL_MAX_RIGHT, I.default.VIEW_LOGICAL_MAX_BOTTOM, I.default.VIEW_LOGICAL_MAX_TOP),
    ...
    function s() {
        ...
        function t() {
            _(),
            (window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame)(t, F)
        }())
    }
    function _() {
        w.default.reset(),
    ...
    function u(t) {
        ...
        var i = F.getBoundingClientRect()
          ...
          , n = y(o.x - i.left)
          , s = m(o.y - i.top);
        I.default.DEBUG_MOUSE_LOG && console.log("modelTurnHead onMouseMove device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + n + " y:" + s + ")"),
        Y = e,
        k = r,
        C.setPoint(n, s)
    }
    function p(t) {
        ...
        var i = F.getBoundingClientRect()
          ...
          , n = y(o.x - i.left)
          , s = m(o.y - i.top);
        I.default.DEBUG_MOUSE_LOG && console.log("modelTapEvent onMouseDown device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + n + " y:" + s + ")"),
        Y = e,
        k = r,
        D.tapEvent(n, s)
    }
    function f(t) {
        var i = F.getBoundingClientRect()
          ...
          , n = y(o.x - i.left)
          , s = m(o.y - i.top);
        I.default.DEBUG_MOUSE_LOG && console.log("followPointer onMouseMove device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + n + " y:" + s + ")"),
        G && (Y = e,
        k = r,
        C.setPoint(n, s))
    }
    ...
    function d(t) {
        var i = t.touches[0];
        "touchstart" == t.type ? 1 == t.touches.length && p(i) : "touchmove" == t.type ? f(i) : "touchend" == t.type && c()
    }
    function y(t) {
        ...
        !function() {
            ...
            i._$62 = function(t, e) {
                try {
                    ...
                    var r, o = new vt(e), n = o._$ST(), s = o._$ST(), a = o._$ST();
                    if (109 != n || 111 != s || 99 != a)
            ...
            e.prototype.calcClippedDrawTotalBounds = function(t, i) {
                for (var e = t._$Ri.getModelImpl().getCanvasWidth(), r = t._$Ri.getModelImpl().getCanvasHeight(), o = e > r ? e : r, n = o, s = o, _ = 0, a = 0, h = i.clippedDrawContextList.length, l = 0; l < h; l++) {
                    var $ = i.clippedDrawContextList[l]
                      ...
                      , p = t._$C2(u);
                    if (p._$yo()) {
                        for (var f = p.getTransformedPoints(), c = f.length, g = [], d = [], y = 0, m = U._$i2; m < c; m += U._$No)
                            g[y] = f[m],
                            d[y] = f[m + 1],
                            y++;
            ...
            S._$br = function(t, i, e, r) {
                ...
                if (3 == o) {
                    var p = r[n[0]]
                      ...
                      , u = s[1]
                      , P = s[2];
                    return (1 - P) * ((1 - u) * (p + (f - p) * h) + u * (c + (g - c) * h)) + P * ((1 - u) * (d + (y - d) * h) + u * (m + (T - m) * h))
                }
                if (4 == o) {
                    var v = r[n[0]]
                      , S = r[n[1]]
                      ...
                      , P = s[2]
                      , B = s[3];
                    return (1 - B) * ((1 - P) * ((1 - u) * (v + (S - v) * h) + u * (L + (M - L) * h)) + P * ((1 - u) * (E + (A - E) * h) + u * (I + (x - I) * h))) + B * ((1 - P) * ((1 - u) * (w + (O - w) * h) + u * (D + (R - D) * h)) + P * ((1 - u) * (b + (F - b) * h) + u * (C + (N - C) * h)))
                }
            ...
            S._$Vr = function(t, i, e, r, o, n, s, _) {
                ...
                if (a <= 0) {
                    ...
                    for (var f = o[h[0]], g = o[h[1]], d = l[0], y = 1 - d, c = 0; c < $; )
                        n[u] = f[c] * y + g[c] * d,
                        ++c,
                        n[u + 1] = f[c] * y + g[c] * d,
                        ++c,
                    ...
                    for (var f = o[h[0]], g = o[h[1]], m = o[h[2]], T = o[h[3]], d = l[0], P = l[1], y = 1 - d, v = 1 - P, S = v * y, L = v * d, M = P * y, E = P * d, c = 0; c < $; )
                    ...
                    for (var A = o[h[0]], I = o[h[1]], w = o[h[2]], O = o[h[3]], D = o[h[4]], R = o[h[5]], b = o[h[6]], F = o[h[7]], d = l[0], P = l[1], C = l[2], y = 1 - d, v = 1 - P, N = 1 - C, B = N * v * y, U = N * v * d, G = N * P * y, Y = N * P * d, k = C * v * y, V = C * v * d, X = C * P * y, z = C * P * d, c = 0; c < $; )
                    ...
                    for (var H = o[h[0]], W = o[h[1]], j = o[h[2]], q = o[h[3]], J = o[h[4]], Q = o[h[5]], Z = o[h[6]], K = o[h[7]], tt = o[h[8]], it = o[h[9]], et = o[h[10]], rt = o[h[11]], ot = o[h[12]], nt = o[h[13]], st = o[h[14]], _t = o[h[15]], d = l[0], P = l[1], C = l[2], at = l[3], y = 1 - d, v = 1 - P, N = 1 - C, ht = 1 - at, lt = ht * N * v * y, $t = ht * N * v * d, ut = ht * N * P * y, pt = ht * N * P * d, ft = ht * C * v * y, ct = ht * C * v * d, gt = ht * C * P * y, dt = ht * C * P * d, yt = at * N * v * y, mt = at * N * v * d, Tt = at * N * P * y, Pt = at * N * P * d, vt = at * C * v * y, St = at * C * v * d, Lt = at * C * P * y, Mt = at * C * P * d, c = 0; c < $; )
                        n[u] = lt * H[c] + $t * W[c] + ut * j[c] + pt * q[c] + ft * J[c] + ct * Q[c] + gt * Z[c] + dt * K[c] + yt * tt[c] + mt * it[c] + Tt * et[c] + Pt * rt[c] + vt * ot[c] + St * nt[c] + Lt * st[c] + Mt * _t[c],
                        ++c,
                        n[u + 1] = lt * H[c] + $t * W[c] + ut * j[c] + pt * q[c] + ft * J[c] + ct * Q[c] + gt * Z[c] + dt * K[c] + yt * tt[c] + mt * it[c] + Tt * et[c] + Pt * rt[c] + vt * ot[c] + St * nt[c] + Lt * st[c] + Mt * _t[c],
                        ++c,
                        u += _;
                else {
                ...
                for (var u = null, p = 0; p < r; ++p) {
                    ...
                    try {
                        ...
                        c._$u2())
                            continue;
                        f._$2b(this, c);
                        var g, d = Math.floor(f._$zS(this, c) - o);
                        try {
                            g = this._$Vs[d]
                        } catch (t) {
            ...
            z.prototype._$Nr = function(t, i) {
                ...
                if (this._$GS._$Ur(t)) {
                    ...
                    o <= 0) {
                        ...
                        e._$Yr._$fL = (1 - k) * ((1 - S) * (p + (f - p) * u) + S * (L + (M - L) * u)) + k * ((1 - S) * (V + (X - V) * u) + S * (H + (W - H) * u)),
                        ...
                        e._$Yr._$gL = (1 - k) * ((1 - S) * (p + (f - p) * u) + S * (L + (M - L) * u)) + k * ((1 - S) * (V + (X - V) * u) + S * (H + (W - H) * u)),
                        ...
                        e._$Yr._$B0 = (1 - k) * ((1 - S) * (p + (f - p) * u) + S * (L + (M - L) * u)) + k * ((1 - S) * (V + (X - V) * u) + S * (H + (W - H) * u)),
                        ...
                        e._$Yr._$z0 = (1 - k) * ((1 - S) * (p + (f - p) * u) + S * (L + (M - L) * u)) + k * ((1 - S) * (V + (X - V) * u) + S * (H + (W - H) * u)),
                        ...
                        e._$Yr._$qT = (1 - k) * ((1 - S) * (p + (f - p) * u) + S * (L + (M - L) * u)) + k * ((1 - S) * (V + (X - V) * u) + S * (H + (W - H) * u))
                    } else {
            ...
            z.prototype._$nb = function(t, i, e, r, o, n, s) {
                this != i._$GT() && console.log("### assert!! ### ");
                for (var _, a, h = i, l = null != h._$Wr ? h._$Wr : h._$Yr, $ = Math.sin(Lt._$bS * l._$qT), u = Math.cos(Lt._$bS * l._$qT), p = h.getTotalScale(), f = l.reflectX ? -1 : 1, c = l.reflectY ? -1 : 1, g = u * p * f, d = -$ * p * c, y = $ * p * f, m = u * p * c, T = l._$fL, P = l._$gL, v = o * s, S = n; S < v; S += s)
                    _ = e[S],
                    a = e[S + 1],
                    r[S] = g * _ + d * a + T,
                    r[S + 1] = y * _ + m * a + P
            ...
            J.prototype.updateParamExe = function(t, i, e, r) {
                for (var o = i - r._$z2, n = o * this._$D0 / 1e3, s = 0 | n, _ = n - s, a = 0; a < this.motions.length; a++) {
                    ...
                    if (h._$RP == B._$hs) {
                        ...
                        var p, f = t.getParamIndex($), c = t.getModelContext(), g = c.getParamMax(f), d = c.getParamMin(f), y = .4 * (g - d), m = c.getParamFloat(f), T = h._$I0[s >= l ? l - 1 : s], P = h._$I0[s + 1 >= l ? l - 1 : s + 1];
            ...
            Z.transformPoints_sdk2 = function(i, e, r, o, n, s, _, a) {
                for (var h, l, $, u = r * n, p = 0, f = 0, c = 0, g = 0, d = 0, y = 0, m = !1, T = o; T < u; T += n) {
                    var P, v, S, L;
                    if (S = i[T],
                    L = i[T + 1],
                    P = S * _,
            ...
            Z.prototype.transformPoints_sdk1 = function(t, i, e, r, o, n, s) {
                for (var _, a, h, l, $, u, p, f = i, c = this._$o, g = this._$A, d = o * s, y = null != f._$hr ? f._$hr : f._$Cr, m = n; m < d; m += s)
                    at._$ts ? (_ = e[m],
                    a = e[m + 1],
                    _ < 0 ? _ = 0 : _ > 1 && (_ = 1),
                    a < 0 ? a = 0 : a > 1 && (a = 1),
            ...
            nt.prototype.drawElements = function(t, i, e, r, o, n, s, a) {
                try {
                    ...
                    for (var h = i.length, l = t.width, $ = t.height, u = this.context, p = this._$xP, f = this._$uP, c = this._$6r, g = this._$3r, d = nt.tr, y = nt._$Ti, m = nt._$Pi, T = nt._$B, P = 0; P < h; P += 3) {
                        u.save();
                        var v = i[P]
                          , S = i[P + 1]
                          , L = i[P + 2]
                        ...
                        at.USE_CACHED_POLYGON_IMAGE) {
                            ...
                            at.IGNORE_CLIP || nt.clip(u, d, n, Y, O, D, R, b, F, C, M, E, A, I, x, w),
            ...
            $t.prototype._$Nr = function(t, i) {
                ...
                !e._$IS[0])) {
                    var r = $t._$gT;
                    r[0] = !1,
                    S._$Vr(t, this._$GS, r, this._$d0, this._$Eo, e._$Cr, U._$i2, U._$No)
                }
            }
            ,
...
, function(t, i, e) {
    ...
    o.prototype.update = function() {
        ...
        var t = UtSystem.getUserTimeMSec() - this.startTimeMSec
          , i = t / 1e3
          , e = 2 * i * Math.PI;
        this.mainMotionManager.isFinished() && this.startRandomMotion(h.default.MOTION_GROUP_IDLE, h.default.PRIORITY_IDLE),
